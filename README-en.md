...
You may see some non-English characters that you don’t understand: don't worry, this means the app doesn't have English version yet.
...
for the 21st Century by GitHub. ![star 4][star4 Icon] [![Open-Source Software][OSS Icon]](https://github.com/atom/atom) ![Freeware][Freeware Icon] ![hot][hot Icon] ![tuijian][tuijian Icon] ![must-have][bibei Icon]
    * Common
        ...
        * [autocomplete-paths](https://atom.io/packages/autocomplete-paths) - Autocomplete + path suggestions
...
* [BBEdit](http://www.barebones.com/products/bbedit/) - An editor that doesn’t suck.
...
* [Vimr](http://vimr.org/) - Refined Vim Experience for macOS. [![Open-Source Software][OSS Icon]](https://github.com/qvacua/vimr/) ![Freeware][Freeware Icon]
...
* [Gas Mask](https://github.com/2ndalpha/gasmask) - A tool to edit your hosts file in an easy and convenitent fashion. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon] ![hot][hot Icon] ![must-have][bibei Icon]](https://github.com/2ndalpha/gasmask)
...
* [EnvPane](https://github.com/hschmidt/EnvPane) - A macOS preference pane for environment variables. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/hschmidt/EnvPane)
...
* [Dlite](https://github.com/nlf/dlite) - The simplest way to use Docker on macOS. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/nlf/dlite)
...
*推荐一些通信工具，沟通，团队协同。 Team communication and collaboration tool recommendation *  
...
* [Skype](https://www.skype.com/) - Skype共享、跨平台的短信和电话。 A cross-platform application that provides video chat and voice call services, users can exchange images, text, video and any other digital documents.
...
* [Gitter](https://gitter.im) - 关于Github的项目交流，支持 Markdown，对开发者极为友好。 An instant messaging and chat room system for developers and users of GitHub repositories, support Markdown and friendly to developers.
...
* [钉钉](http://www.dingtalk.com/index-b.html#download_block) - 企业级办公通讯免费平台。 A free office communication platform for enterprise. ![Freeware][Freeware Icon]
* [Slack](https://slack.com/) - 团队协作，沟通工具。 A tool for team collaboration and communication.
* [Airmail](http://airmailapp.com) - 快速的邮件客户端支持Mac和iPhone。 A fast email client, can run on your Mac and iPhone.
* [Foxmail](http://www.foxmail.com/mac/) - 快速的邮件客户端。 A fast email client. ![Freeware][Freeware Icon] ![hot][hot Icon] ![tuijian][tuijian Icon]
* [Postbox](https://www.postbox-inc.com) - 这个貌似也非常强大哦，关键是简洁漂亮的收费邮件客户端。 A powerful, simple and beautiful email client, need to pay for a license.
* [零信](https://pubu.im/apps/osx) - 随时随地工作, 跨平台 Work anywhere and anytime, cross platform
* [今目标](http://www.jingoal.com/client/mac/mac.htm) - 一款面向中小企业的互联网工作平台。 An internet work platform for small-medium sized enterprises.
* [N1](https://www.nylas.com/n1) - 可以扩展的开源收费邮件客户端。 An extensible, open source mail app, free for developers and $7 per month for Pro.
* [Bitpost](https://voluntary.net/bitpost/) - 私人分散消息。它是一个p2p的去中心化和无须第三方提供信用担保协议。 A private decentralized messaging system. Instead of connecting to centralized servers(like Facebook, Gmail, etc) or federated servers(like email, IRC, Jabber), it use P2P protocol to send encrypted messages to another person or to many subscribers.  [![Open-Source Software][OSS Icon]](https://github.com/Voluntarynet/Bitpost)
* [Teambition](https://www.teambition.com) - 团队协作。提供管理任务、安排日程、查找文件、即时讨论等团队所需要的一切协作功能。 A team collaboration tool, provides many features like task plan, schedule, file sharing, instant discussion and everything you need when collaborate with other team members.  ![Freeware][Freeware Icon]
* [Coding.net](https://coding.net) - 一站式云端开发平台，免费提供代码托管，项目协作，代码质量管理，Pages 等服务。 A one-stop cloud platform for developers, free for repository hosting, project collaboration, code quality assurance and Page service. ![Freeware][Freeware Icon]

## Data Recovery

* [DiskWarrior](http://www.alsoft.com/DiskWarrior/) - 恢复文件系统损坏时，磁盘工具进行选择。 A disk utility, the world’s most advanced repair and recovery tool for Mac.
* [Data Rescue](https://www.prosofteng.com/datarescue-mac-data-recovery/) - 多种情况下的全面和专业的数据恢复。 A comprehensive and professional data recovery tool in most cases.
...
* [BetterZip 3](https://macitbetter.com/) - 压缩解压缩工具支持格式 ZIP、TAR、TGZ、TBZ、TXZ (new)、7-ZIP、RAR。 ![Freeware][Freeware Icon] ![hot][hot Icon] ![tuijian][tuijian Icon] ![must-have][bibei Icon]
...
* [1password](https://1password.com/) - 跨平台帐号密码管理软件。![hot][hot Icon] ![tuijian][tuijian Icon] ![must-have][bibei Icon]
...
* [Hammerspoon](http://www.hammerspoon.org/) - A tool for powerful automation of OS X, programmable by Lua scripting engine.
...
* [Itsycal](https://www.mowglii.com/itsycal/) - Itsycal is a tiny calendar for your Mac's menu bar. [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/sfsam/itsycal)
